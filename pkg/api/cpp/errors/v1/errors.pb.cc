...
static constexpr const ::_pb::EnumDescriptor**
    file_level_enum_descriptors_errors_2fv1_2ferrors_2eproto = nullptr;
static constexpr const ::_pb::ServiceDescriptor**
    file_level_service_descriptors_errors_2fv1_2ferrors_2eproto = nullptr;
const ::uint32_t TableStruct_errors_2fv1_2ferrors_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_errors_2fv1_2ferrors_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    ...
    "e\030\002 \001(\tR\007messageB\265\001\n)com.github.mxplusb."
    "pleiades.api.errors.v1B\013ErrorsProtoP\001Z6g"
    "ithub.com/mxplusb/pleiades/pkg/api/error"
    "s/v1;errorsv1\242\002\003EXX\252\002\tErrors.V1\312\002\tErrors"
    "\\V1\342\002\025Errors\\V1\\GPBMetadata\352\002\nErrors::V1"
    "b\006proto3"
};
...
static ::absl::once_flag descriptor_table_errors_2fv1_2ferrors_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_errors_2fv1_2ferrors_2eproto = {
    false,
    false,
    328,
    descriptor_table_protodef_errors_2fv1_2ferrors_2eproto,
    "errors/v1/errors.proto",
    &descriptor_table_errors_2fv1_2ferrors_2eproto_once,
    descriptor_table_errors_2fv1_2ferrors_2eproto_deps,
    1,
    1,
    schemas,
    file_default_instances,
    TableStruct_errors_2fv1_2ferrors_2eproto::offsets,
    file_level_metadata_errors_2fv1_2ferrors_2eproto,
    file_level_enum_descriptors_errors_2fv1_2ferrors_2eproto,
...
static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_errors_2fv1_2ferrors_2eproto(&descriptor_table_errors_2fv1_2ferrors_2eproto);
namespace errors {
namespace v1 {
// ===================================================================
...
::uint8_t* Error::_InternalSerialize(
  ...
  if (!this->_internal_message().empty()) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "errors.v1.Error.message");
