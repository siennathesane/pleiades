...
func (this *KVStoreWrapper_GetAccountDescriptorReply) EqualVT(thatIface isKVStoreWrapper_Payload) bool {
	...
	if p, q := this.GetAccountDescriptorReply, that.GetAccountDescriptorReply; p != q {
		if p == nil {
			p = &GetAccountDescriptorResponse{}
		}
		if q == nil {
			q = &GetAccountDescriptorResponse{}
		}
		if !p.EqualVT(q) {
			return false
		}
...
func (this *KVStoreWrapper_CreateBucketReply) EqualVT(thatIface isKVStoreWrapper_Payload) bool {
	...
	if p, q := this.CreateBucketReply, that.CreateBucketReply; p != q {
		if p == nil {
			p = &CreateBucketResponse{}
		}
		if q == nil {
			q = &CreateBucketResponse{}
		}
		if !p.EqualVT(q) {
			return false
		}
...
func (this *KVStoreWrapper_DeleteBucketReply) EqualVT(thatIface isKVStoreWrapper_Payload) bool {
	...
	if p, q := this.DeleteBucketReply, that.DeleteBucketReply; p != q {
		if p == nil {
			p = &DeleteBucketResponse{}
		}
		if q == nil {
			q = &DeleteBucketResponse{}
		}
		if !p.EqualVT(q) {
			return false
		}
...
func (this *KVStoreWrapper_GetBucketDescriptorReply) EqualVT(thatIface isKVStoreWrapper_Payload) bool {
	...
	if p, q := this.GetBucketDescriptorReply, that.GetBucketDescriptorReply; p != q {
		if p == nil {
			p = &GetBucketDescriptorResponse{}
		}
		if q == nil {
			q = &GetBucketDescriptorResponse{}
		}
		if !p.EqualVT(q) {
			return false
		}
...
func (this *KVStoreWrapper_Error) EqualVT(thatIface isKVStoreWrapper_Payload) bool {
	...
	if p, q := this.Error, that.Error; p != q {
		...
		if equal, ok := interface{}(p).(interface{ EqualVT(*errorspb.Error) bool }); ok {
			if !equal.EqualVT(q) {
				return false
			}
...
func (this *Value) EqualVT(that *Value) bool {
	...
	if string(this.RawBytes) != string(that.RawBytes) {
		return false
	}
...
func (m *Timestamp) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.Logical != 0 {
		i = encodeVarint(dAtA, i, uint64(m.Logical))
		i--
		dAtA[i] = 0x10
	}
	if m.WallTime != 0 {
