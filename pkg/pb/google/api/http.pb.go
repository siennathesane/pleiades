...
//         option (google.api.http).get = "/config/messages/{message_id}/{sub.subfield}";
//       }
//     }
...
//           get: /config/messages/{message_id}/{sub.subfield}
//
...
// HTTP | RPC
// -----|-----
// `GET /config/messages/123456/foo`  | `GetMessage(message_id: "123456" sub: SubMessage(subfield: "foo"))`
//
...
//     service Messaging {
//       rpc GetMessage(GetMessageRequest) returns (Message) {
//         option (google.api.http).get = "/config/messages/{message_id}";
//       }
//     }
//     message GetMessageRequest {
//       message SubMessage {
...
// HTTP | RPC
// -----|-----
// `GET /config/messages/123456?revision=2&sub.subfield=foo` | `GetMessage(message_id: "123456" revision: 2 sub: SubMessage(subfield: "foo"))`
//
...
//           put: "/config/messages/{message_id}"
//           body: "message"
//         };
//       }
//     }
...
// HTTP | RPC
// -----|-----
// `PUT /config/messages/123456 { "text": "Hi!" }` | `UpdateMessage(message_id: "123456" message { text: "Hi!" })`
//
...
// HTTP | RPC
// -----|-----
// `PUT /config/messages/123456 { "text": "Hi!" }` | `UpdateMessage(message_id: "123456" text: "Hi!")`
//
...
//       rpc GetMessage(GetMessageRequest) returns (Message) {
//         option (google.api.http) = {
//           get: "/config/messages/{message_id}"
//           additional_bindings {
//             get: "/config/users/{user_id}/messages/{message_id}"
//           }
//         };
//       }
//     }
...
// HTTP | RPC
// -----|-----
// `GET /config/messages/123456` | `GetMessage(message_id: "123456")`
// `GET /config/users/me/messages/123456` | `GetMessage(user_id: "me" message_id: "123456")`
//
...
var file_google_api_http_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x04, 0x70, 0x61, 0x74, 0x68, 0x42, 0x8a, 0x01, 0x0a, 0x0e, 0x63, 0x6f, 0x6d,
	0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x61, 0x70, 0x69, 0x42, 0x09, 0x48, 0x74, 0x74,
	0x70, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x21, 0x72, 0x33, 0x74, 0x2e, 0x69, 0x6f,
	0x2f, 0x70, 0x6c, 0x65, 0x69, 0x61, 0x64, 0x65, 0x73, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x70, 0x62,
