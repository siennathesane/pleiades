...
func (this *UserAddOptions) EqualVT(that *UserAddOptions) bool {
	if this == nil {
		return that == nil || fmt.Sprintf("%v", that) == ""
	} else if that == nil {
		return fmt.Sprintf("%v", this) == ""
	}
	if this.NoPassword != that.NoPassword {
		return false
	}
...
func (this *User) EqualVT(that *User) bool {
	...
	if string(this.Password) != string(that.Password) {
		return false
	}
...
func (this *Permission) EqualVT(that *Permission) bool {
	...
	if this.PermType != that.PermType {
		return false
	}
...
func (this *Role) EqualVT(that *Role) bool {
	...
	if len(this.KeyPermission) != len(that.KeyPermission) {
		return false
	}
	for i := range this.KeyPermission {
		if !this.KeyPermission[i].EqualVT(that.KeyPermission[i]) {
			return false
		}
	}
	return string(this.unknownFields) == string(that.unknownFields)
