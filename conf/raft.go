...
//func NewRaftConfig(client *api.Client, sugaredLogger sugaredLogger.ILogger) (config.Config, error) {
...
//	}
//
//	pair, _, err := client.KV().Get(fmt.Sprintf("hosts/%s/conf/raft", hostname), &api.QueryOptions{})
//	if err != nil {
