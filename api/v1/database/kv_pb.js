...
goog.exportSymbol('proto.database.EventPayload', null, global);
goog.exportSymbol('proto.database.EventPayload.MethodName', null, global);
goog.exportSymbol('proto.database.EventPayload.TypeCase', null, global);
goog.exportSymbol('proto.database.KeyValue', null, global);
goog.exportSymbol('proto.database.KeyValueOperation', null, global);
/**
 ...
 * @constructor
 */
proto.database.EventPayload = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, proto.database.EventPayload.oneofGroups_);
};
goog.inherits(proto.database.EventPayload, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.database.EventPayload.displayName = 'proto.database.EventPayload';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.database.KeyValueOperation = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.database.KeyValueOperation, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.database.KeyValueOperation.displayName = 'proto.database.KeyValueOperation';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.database.EventPayload.oneofGroups_ = [[1]];

/**
 * @enum {number}
 */
proto.database.EventPayload.TypeCase = {
  TYPE_NOT_SET: 0,
  KEYVALUEOPERATION: 1
};

/**
 * @return {proto.database.EventPayload.TypeCase}
 */
proto.database.EventPayload.prototype.getTypeCase = function() {
  return /** @type {proto.database.EventPayload.TypeCase} */(jspb.Message.computeOneofCase(this, proto.database.EventPayload.oneofGroups_[0]));
};
 ...
 * @return {!Object}
 */
proto.database.EventPayload.prototype.toObject = function(opt_includeInstance) {
  return proto.database.EventPayload.toObject(opt_includeInstance, this);
};
 ...
 *     http://goto/soy-param-migration
 * @param {!proto.database.EventPayload} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.database.EventPayload.toObject = function(includeInstance, msg) {
  var f, obj = {
    keyvalueoperation: (f = msg.getKeyvalueoperation()) && proto.database.KeyValueOperation.toObject(includeInstance, f),
 ...
 * @return {!proto.database.EventPayload}
 */
proto.database.EventPayload.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.database.EventPayload;
  return proto.database.EventPayload.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @param {!proto.database.EventPayload} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.database.EventPayload}
 */
proto.database.EventPayload.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.database.KeyValueOperation;
      reader.readMessage(value,proto.database.KeyValueOperation.deserializeBinaryFromReader);
      msg.setKeyvalueoperation(value);
      break;
    case 2:
      var value = /** @type {!proto.database.EventPayload.MethodName} */ (reader.readEnum());
      msg.setMethod(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.database.EventPayload.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.database.EventPayload.serializeBinaryToWriter(this, writer);
 ...
 * @param {!proto.database.EventPayload} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.database.EventPayload.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getKeyvalueoperation();
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.database.KeyValueOperation.serializeBinaryToWriter
    );
  }
  f = message.getMethod();
  if (f !== 0.0) {
 ...
 * @enum {number}
 */
proto.database.EventPayload.MethodName = {
  UNKNOWN: 0
};

/**
 * optional KeyValueOperation KeyValueOperation = 1;
 * @return {?proto.database.KeyValueOperation}
 */
proto.database.EventPayload.prototype.getKeyvalueoperation = function() {
  return /** @type{?proto.database.KeyValueOperation} */ (
    jspb.Message.getWrapperField(this, proto.database.KeyValueOperation, 1));
};


/**
 * @param {?proto.database.KeyValueOperation|undefined} value
 * @return {!proto.database.EventPayload} returns this
*/
proto.database.EventPayload.prototype.setKeyvalueoperation = function(value) {
  return jspb.Message.setOneofWrapperField(this, 1, proto.database.EventPayload.oneofGroups_[0], value);
};
 ...
 * @return {!proto.database.EventPayload} returns this
 */
proto.database.EventPayload.prototype.clearKeyvalueoperation = function() {
  return this.setKeyvalueoperation(undefined);
};
 ...
 * @return {boolean}
 */
proto.database.EventPayload.prototype.hasKeyvalueoperation = function() {
  return jspb.Message.getField(this, 1) != null;
};


/**
 * optional MethodName Method = 2;
 * @return {!proto.database.EventPayload.MethodName}
 */
proto.database.EventPayload.prototype.getMethod = function() {
  return /** @type {!proto.database.EventPayload.MethodName} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};


/**
 * @param {!proto.database.EventPayload.MethodName} value
 * @return {!proto.database.EventPayload} returns this
 */
proto.database.EventPayload.prototype.setMethod = function(value) {
 ...
 * @return {!Object}
 */
proto.database.KeyValueOperation.prototype.toObject = function(opt_includeInstance) {
  return proto.database.KeyValueOperation.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.database.KeyValueOperation} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.database.KeyValueOperation.toObject = function(includeInstance, msg) {
  var f, obj = {
    session: (f = msg.getSession()) && api_v1_database_session_pb.Session.toObject(includeInstance, f),
    event: (f = msg.getEvent()) && proto.database.Event.toObject(includeInstance, f)
  };
 ...
 * @return {!proto.database.KeyValueOperation}
 */
proto.database.KeyValueOperation.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.database.KeyValueOperation;
  return proto.database.KeyValueOperation.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.database.KeyValueOperation} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.database.KeyValueOperation}
 */
proto.database.KeyValueOperation.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.database.Event;
      reader.readMessage(value,proto.database.Event.deserializeBinaryFromReader);
      msg.setEvent(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.database.KeyValueOperation.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.database.KeyValueOperation.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.database.KeyValueOperation} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.database.KeyValueOperation.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.database.Event.serializeBinaryToWriter
    );
  }
};
 ...
 */
proto.database.KeyValueOperation.prototype.getSession = function() {
  return /** @type{?proto.database.Session} */ (
    jspb.Message.getWrapperField(this, api_v1_database_session_pb.Session, 1));
};


/**
 * @param {?proto.database.Session|undefined} value
 * @return {!proto.database.KeyValueOperation} returns this
*/
proto.database.KeyValueOperation.prototype.setSession = function(value) {
 ...
 * @return {!proto.database.KeyValueOperation} returns this
 */
proto.database.KeyValueOperation.prototype.clearSession = function() {
 ...
 * @return {boolean}
 */
proto.database.KeyValueOperation.prototype.hasSession = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 */
proto.database.KeyValueOperation.prototype.getEvent = function() {
  return /** @type{?proto.database.Event} */ (
    jspb.Message.getWrapperField(this, proto.database.Event, 2));
};


/**
 * @param {?proto.database.Event|undefined} value
 * @return {!proto.database.KeyValueOperation} returns this
*/
proto.database.KeyValueOperation.prototype.setEvent = function(value) {
 ...
 * @return {!proto.database.KeyValueOperation} returns this
 */
proto.database.KeyValueOperation.prototype.clearEvent = function() {
 ...
 * @return {boolean}
 */
proto.database.KeyValueOperation.prototype.hasEvent = function() {
