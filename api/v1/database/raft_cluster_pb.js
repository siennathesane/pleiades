...
goog.exportSymbol('proto.database.RaftClusterPayload', null, global);
goog.exportSymbol('proto.database.RaftClusterPayload.MethodName', null, global);
goog.exportSymbol('proto.database.RaftClusterPayload.TypeCase', null, global);
 ...
 * @constructor
 */
proto.database.RaftClusterPayload = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, proto.database.RaftClusterPayload.oneofGroups_);
};
goog.inherits(proto.database.RaftClusterPayload, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.database.RaftClusterPayload.displayName = 'proto.database.RaftClusterPayload';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.database.RaftClusterPayload.oneofGroups_ = [[1,2,3,4,5,6]];

/**
 * @enum {number}
 */
proto.database.RaftClusterPayload.TypeCase = {
  TYPE_NOT_SET: 0,
...
/**
 * @return {proto.database.RaftClusterPayload.TypeCase}
 */
proto.database.RaftClusterPayload.prototype.getTypeCase = function() {
  return /** @type {proto.database.RaftClusterPayload.TypeCase} */(jspb.Message.computeOneofCase(this, proto.database.RaftClusterPayload.oneofGroups_[0]));
};
 ...
 * @return {!Object}
 */
proto.database.RaftClusterPayload.prototype.toObject = function(opt_includeInstance) {
  return proto.database.RaftClusterPayload.toObject(opt_includeInstance, this);
};
 ...
 *     http://goto/soy-param-migration
 * @param {!proto.database.RaftClusterPayload} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.database.RaftClusterPayload.toObject = function(includeInstance, msg) {
  var f, obj = {
    getclustermembershiprequest: (f = msg.getGetclustermembershiprequest()) && proto.database.GetClusterMembershipRequest.toObject(includeInstance, f),
    getclustermembershipresponse: (f = msg.getGetclustermembershipresponse()) && proto.database.GetClusterMembershipResponse.toObject(includeInstance, f),
    stopclusterrequest: (f = msg.getStopclusterrequest()) && proto.database.StopClusterRequest.toObject(includeInstance, f),
    stopclusterresponse: (f = msg.getStopclusterresponse()) && proto.database.StopClusterResponse.toObject(includeInstance, f),
    startclusterrequest: (f = msg.getStartclusterrequest()) && proto.database.StartClusterRequest.toObject(includeInstance, f),
    startclusterresponse: (f = msg.getStartclusterresponse()) && proto.database.StartClusterResponse.toObject(includeInstance, f),
 ...
 * @return {!proto.database.RaftClusterPayload}
 */
proto.database.RaftClusterPayload.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.database.RaftClusterPayload;
  return proto.database.RaftClusterPayload.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @param {!proto.database.RaftClusterPayload} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.database.RaftClusterPayload}
 */
proto.database.RaftClusterPayload.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.database.GetClusterMembershipRequest;
      reader.readMessage(value,proto.database.GetClusterMembershipRequest.deserializeBinaryFromReader);
      msg.setGetclustermembershiprequest(value);
      break;
    case 2:
      var value = new proto.database.GetClusterMembershipResponse;
      reader.readMessage(value,proto.database.GetClusterMembershipResponse.deserializeBinaryFromReader);
      msg.setGetclustermembershipresponse(value);
      break;
    case 3:
      var value = new proto.database.StopClusterRequest;
      reader.readMessage(value,proto.database.StopClusterRequest.deserializeBinaryFromReader);
      msg.setStopclusterrequest(value);
      break;
    case 4:
      var value = new proto.database.StopClusterResponse;
      reader.readMessage(value,proto.database.StopClusterResponse.deserializeBinaryFromReader);
      msg.setStopclusterresponse(value);
      break;
    case 5:
      var value = new proto.database.StartClusterRequest;
      reader.readMessage(value,proto.database.StartClusterRequest.deserializeBinaryFromReader);
      msg.setStartclusterrequest(value);
      break;
    case 6:
      var value = new proto.database.StartClusterResponse;
      reader.readMessage(value,proto.database.StartClusterResponse.deserializeBinaryFromReader);
      msg.setStartclusterresponse(value);
      break;
    case 7:
      var value = /** @type {!proto.database.RaftClusterPayload.MethodName} */ (reader.readEnum());
      msg.setMethod(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.database.RaftClusterPayload.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.database.RaftClusterPayload.serializeBinaryToWriter(this, writer);
 ...
 * @param {!proto.database.RaftClusterPayload} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.database.RaftClusterPayload.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getGetclustermembershiprequest();
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.database.GetClusterMembershipRequest.serializeBinaryToWriter
    );
  }
  f = message.getGetclustermembershipresponse();
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.database.GetClusterMembershipResponse.serializeBinaryToWriter
    );
  }
  f = message.getStopclusterrequest();
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      proto.database.StopClusterRequest.serializeBinaryToWriter
    );
  }
  f = message.getStopclusterresponse();
  if (f != null) {
    writer.writeMessage(
      4,
      f,
      proto.database.StopClusterResponse.serializeBinaryToWriter
    );
  }
  f = message.getStartclusterrequest();
  if (f != null) {
    writer.writeMessage(
      5,
      f,
      proto.database.StartClusterRequest.serializeBinaryToWriter
    );
  }
  f = message.getStartclusterresponse();
  if (f != null) {
    writer.writeMessage(
      6,
      f,
      proto.database.StartClusterResponse.serializeBinaryToWriter
    );
  }
  f = message.getMethod();
  if (f !== 0.0) {
 ...
 * @enum {number}
 */
proto.database.RaftClusterPayload.MethodName = {
  START_CLUSTER: 0,
  STOP_CLUSTER: 1,
...
/**
 * optional GetClusterMembershipRequest GetClusterMembershipRequest = 1;
 * @return {?proto.database.GetClusterMembershipRequest}
 */
proto.database.RaftClusterPayload.prototype.getGetclustermembershiprequest = function() {
  return /** @type{?proto.database.GetClusterMembershipRequest} */ (
    jspb.Message.getWrapperField(this, proto.database.GetClusterMembershipRequest, 1));
};


/**
 * @param {?proto.database.GetClusterMembershipRequest|undefined} value
 * @return {!proto.database.RaftClusterPayload} returns this
*/
proto.database.RaftClusterPayload.prototype.setGetclustermembershiprequest = function(value) {
  return jspb.Message.setOneofWrapperField(this, 1, proto.database.RaftClusterPayload.oneofGroups_[0], value);
};
 ...
 * @return {!proto.database.RaftClusterPayload} returns this
 */
proto.database.RaftClusterPayload.prototype.clearGetclustermembershiprequest = function() {
  return this.setGetclustermembershiprequest(undefined);
};
 ...
 * @return {boolean}
 */
proto.database.RaftClusterPayload.prototype.hasGetclustermembershiprequest = function() {
  return jspb.Message.getField(this, 1) != null;
};


/**
 * optional GetClusterMembershipResponse GetClusterMembershipResponse = 2;
 * @return {?proto.database.GetClusterMembershipResponse}
 */
proto.database.RaftClusterPayload.prototype.getGetclustermembershipresponse = function() {
  return /** @type{?proto.database.GetClusterMembershipResponse} */ (
    jspb.Message.getWrapperField(this, proto.database.GetClusterMembershipResponse, 2));
};


/**
 * @param {?proto.database.GetClusterMembershipResponse|undefined} value
 * @return {!proto.database.RaftClusterPayload} returns this
*/
proto.database.RaftClusterPayload.prototype.setGetclustermembershipresponse = function(value) {
  return jspb.Message.setOneofWrapperField(this, 2, proto.database.RaftClusterPayload.oneofGroups_[0], value);
};
 ...
 * @return {!proto.database.RaftClusterPayload} returns this
 */
proto.database.RaftClusterPayload.prototype.clearGetclustermembershipresponse = function() {
  return this.setGetclustermembershipresponse(undefined);
};
 ...
 * @return {boolean}
 */
proto.database.RaftClusterPayload.prototype.hasGetclustermembershipresponse = function() {
  return jspb.Message.getField(this, 2) != null;
};


/**
 * optional StopClusterRequest StopClusterRequest = 3;
 * @return {?proto.database.StopClusterRequest}
 */
proto.database.RaftClusterPayload.prototype.getStopclusterrequest = function() {
  return /** @type{?proto.database.StopClusterRequest} */ (
    jspb.Message.getWrapperField(this, proto.database.StopClusterRequest, 3));
};


/**
 * @param {?proto.database.StopClusterRequest|undefined} value
 * @return {!proto.database.RaftClusterPayload} returns this
*/
proto.database.RaftClusterPayload.prototype.setStopclusterrequest = function(value) {
  return jspb.Message.setOneofWrapperField(this, 3, proto.database.RaftClusterPayload.oneofGroups_[0], value);
};
 ...
 * @return {!proto.database.RaftClusterPayload} returns this
 */
proto.database.RaftClusterPayload.prototype.clearStopclusterrequest = function() {
  return this.setStopclusterrequest(undefined);
};
 ...
 * @return {boolean}
 */
proto.database.RaftClusterPayload.prototype.hasStopclusterrequest = function() {
  return jspb.Message.getField(this, 3) != null;
};


/**
 * optional StopClusterResponse StopClusterResponse = 4;
 * @return {?proto.database.StopClusterResponse}
 */
proto.database.RaftClusterPayload.prototype.getStopclusterresponse = function() {
  return /** @type{?proto.database.StopClusterResponse} */ (
    jspb.Message.getWrapperField(this, proto.database.StopClusterResponse, 4));
};


/**
 * @param {?proto.database.StopClusterResponse|undefined} value
 * @return {!proto.database.RaftClusterPayload} returns this
*/
proto.database.RaftClusterPayload.prototype.setStopclusterresponse = function(value) {
  return jspb.Message.setOneofWrapperField(this, 4, proto.database.RaftClusterPayload.oneofGroups_[0], value);
};
 ...
 * @return {!proto.database.RaftClusterPayload} returns this
 */
proto.database.RaftClusterPayload.prototype.clearStopclusterresponse = function() {
  return this.setStopclusterresponse(undefined);
};
 ...
 * @return {boolean}
 */
proto.database.RaftClusterPayload.prototype.hasStopclusterresponse = function() {
  return jspb.Message.getField(this, 4) != null;
};


/**
 * optional StartClusterRequest StartClusterRequest = 5;
 * @return {?proto.database.StartClusterRequest}
 */
proto.database.RaftClusterPayload.prototype.getStartclusterrequest = function() {
  return /** @type{?proto.database.StartClusterRequest} */ (
    jspb.Message.getWrapperField(this, proto.database.StartClusterRequest, 5));
};


/**
 * @param {?proto.database.StartClusterRequest|undefined} value
 * @return {!proto.database.RaftClusterPayload} returns this
*/
proto.database.RaftClusterPayload.prototype.setStartclusterrequest = function(value) {
  return jspb.Message.setOneofWrapperField(this, 5, proto.database.RaftClusterPayload.oneofGroups_[0], value);
};
 ...
 * @return {!proto.database.RaftClusterPayload} returns this
 */
proto.database.RaftClusterPayload.prototype.clearStartclusterrequest = function() {
  return this.setStartclusterrequest(undefined);
};
 ...
 * @return {boolean}
 */
proto.database.RaftClusterPayload.prototype.hasStartclusterrequest = function() {
  return jspb.Message.getField(this, 5) != null;
};


/**
 * optional StartClusterResponse StartClusterResponse = 6;
 * @return {?proto.database.StartClusterResponse}
 */
proto.database.RaftClusterPayload.prototype.getStartclusterresponse = function() {
  return /** @type{?proto.database.StartClusterResponse} */ (
    jspb.Message.getWrapperField(this, proto.database.StartClusterResponse, 6));
};


/**
 * @param {?proto.database.StartClusterResponse|undefined} value
 * @return {!proto.database.RaftClusterPayload} returns this
*/
proto.database.RaftClusterPayload.prototype.setStartclusterresponse = function(value) {
  return jspb.Message.setOneofWrapperField(this, 6, proto.database.RaftClusterPayload.oneofGroups_[0], value);
};
 ...
 * @return {!proto.database.RaftClusterPayload} returns this
 */
proto.database.RaftClusterPayload.prototype.clearStartclusterresponse = function() {
  return this.setStartclusterresponse(undefined);
};
 ...
 * @return {boolean}
 */
proto.database.RaftClusterPayload.prototype.hasStartclusterresponse = function() {
  return jspb.Message.getField(this, 6) != null;
};


/**
 * optional MethodName Method = 7;
 * @return {!proto.database.RaftClusterPayload.MethodName}
 */
proto.database.RaftClusterPayload.prototype.getMethod = function() {
  return /** @type {!proto.database.RaftClusterPayload.MethodName} */ (jspb.Message.getFieldWithDefault(this, 7, 0));
};


/**
 * @param {!proto.database.RaftClusterPayload.MethodName} value
 * @return {!proto.database.RaftClusterPayload} returns this
 */
proto.database.RaftClusterPayload.prototype.setMethod = function(value) {
