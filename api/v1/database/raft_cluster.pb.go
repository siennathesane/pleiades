...
type RaftClusterPayload_MethodName int32

const (
	RaftClusterPayload_START_CLUSTER          RaftClusterPayload_MethodName = 0
	RaftClusterPayload_STOP_CLUSTER           RaftClusterPayload_MethodName = 1
	RaftClusterPayload_GET_CLUSTER_MEMBERSHIP RaftClusterPayload_MethodName = 2
)

// Enum value maps for RaftClusterPayload_MethodName.
var (
	RaftClusterPayload_MethodName_name = map[int32]string{
		0: "START_CLUSTER",
		1: "STOP_CLUSTER",
		2: "GET_CLUSTER_MEMBERSHIP",
	}
	RaftClusterPayload_MethodName_value = map[string]int32{
		"START_CLUSTER":          0,
		"STOP_CLUSTER":           1,
...
func (x RaftClusterPayload_MethodName) Enum() *RaftClusterPayload_MethodName {
	p := new(RaftClusterPayload_MethodName)
	*p = x
	return p
}

func (x RaftClusterPayload_MethodName) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (RaftClusterPayload_MethodName) Descriptor() protoreflect.EnumDescriptor {
	return file_api_v1_database_raft_cluster_proto_enumTypes[0].Descriptor()
}

func (RaftClusterPayload_MethodName) Type() protoreflect.EnumType {
	return &file_api_v1_database_raft_cluster_proto_enumTypes[0]
}

func (x RaftClusterPayload_MethodName) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use RaftClusterPayload_MethodName.Descriptor instead.
func (RaftClusterPayload_MethodName) EnumDescriptor() ([]byte, []int) {
	return file_api_v1_database_raft_cluster_proto_rawDescGZIP(), []int{0, 0}
}

type RaftClusterPayload struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Types that are assignable to Type:
	//	*RaftClusterPayload_GetClusterMembershipRequest
	//	*RaftClusterPayload_GetClusterMembershipResponse
	//	*RaftClusterPayload_StopClusterRequest
	//	*RaftClusterPayload_StopClusterResponse
...
func (x *RaftClusterPayload) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RaftClusterPayload) ProtoMessage() {}

func (x *RaftClusterPayload) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_database_raft_cluster_proto_msgTypes[0]
...
// Deprecated: Use RaftClusterPayload.ProtoReflect.Descriptor instead.
func (*RaftClusterPayload) Descriptor() ([]byte, []int) {
	return file_api_v1_database_raft_cluster_proto_rawDescGZIP(), []int{0}
}

func (m *RaftClusterPayload) GetType() isRaftClusterPayload_Type {
	if m != nil {
		return m.Type
	}
	return nil
...
func (x *RaftClusterPayload) GetGetClusterMembershipRequest() *GetClusterMembershipRequest {
	if x, ok := x.GetType().(*RaftClusterPayload_GetClusterMembershipRequest); ok {
		return x.GetClusterMembershipRequest
	}
	return nil
}

func (x *RaftClusterPayload) GetGetClusterMembershipResponse() *GetClusterMembershipResponse {
	if x, ok := x.GetType().(*RaftClusterPayload_GetClusterMembershipResponse); ok {
		return x.GetClusterMembershipResponse
	}
	return nil
}

func (x *RaftClusterPayload) GetStopClusterRequest() *StopClusterRequest {
	if x, ok := x.GetType().(*RaftClusterPayload_StopClusterRequest); ok {
		return x.StopClusterRequest
	}
	return nil
}

func (x *RaftClusterPayload) GetStopClusterResponse() *StopClusterResponse {
	if x, ok := x.GetType().(*RaftClusterPayload_StopClusterResponse); ok {
		return x.StopClusterResponse
	}
	return nil
}

func (x *RaftClusterPayload) GetStartClusterRequest() *StartClusterRequest {
	if x, ok := x.GetType().(*RaftClusterPayload_StartClusterRequest); ok {
		return x.StartClusterRequest
	}
	return nil
}

func (x *RaftClusterPayload) GetStartClusterResponse() *StartClusterResponse {
	if x, ok := x.GetType().(*RaftClusterPayload_StartClusterResponse); ok {
		return x.StartClusterResponse
	}
	return nil
}

func (x *RaftClusterPayload) GetMethod() RaftClusterPayload_MethodName {
	if x != nil {
		return x.Method
	}
	return RaftClusterPayload_START_CLUSTER
}

type isRaftClusterPayload_Type interface {
	isRaftClusterPayload_Type()
}

type RaftClusterPayload_GetClusterMembershipRequest struct {
	GetClusterMembershipRequest *GetClusterMembershipRequest `protobuf:"bytes,1,opt,name=GetClusterMembershipRequest,proto3,oneof"`
}

type RaftClusterPayload_GetClusterMembershipResponse struct {
	GetClusterMembershipResponse *GetClusterMembershipResponse `protobuf:"bytes,2,opt,name=GetClusterMembershipResponse,proto3,oneof"`
}

type RaftClusterPayload_StopClusterRequest struct {
	StopClusterRequest *StopClusterRequest `protobuf:"bytes,3,opt,name=StopClusterRequest,proto3,oneof"`
}

type RaftClusterPayload_StopClusterResponse struct {
	StopClusterResponse *StopClusterResponse `protobuf:"bytes,4,opt,name=StopClusterResponse,proto3,oneof"`
}

type RaftClusterPayload_StartClusterRequest struct {
	StartClusterRequest *StartClusterRequest `protobuf:"bytes,5,opt,name=StartClusterRequest,proto3,oneof"`
}

type RaftClusterPayload_StartClusterResponse struct {
	StartClusterResponse *StartClusterResponse `protobuf:"bytes,6,opt,name=StartClusterResponse,proto3,oneof"`
}

func (*RaftClusterPayload_GetClusterMembershipRequest) isRaftClusterPayload_Type() {}

func (*RaftClusterPayload_GetClusterMembershipResponse) isRaftClusterPayload_Type() {}

func (*RaftClusterPayload_StopClusterRequest) isRaftClusterPayload_Type() {}

func (*RaftClusterPayload_StopClusterResponse) isRaftClusterPayload_Type() {}

func (*RaftClusterPayload_StartClusterRequest) isRaftClusterPayload_Type() {}

func (*RaftClusterPayload_StartClusterResponse) isRaftClusterPayload_Type() {}
...
func (x *RaftConfig) Reset() {
	*x = RaftConfig{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_v1_database_raft_cluster_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RaftConfig) Descriptor() ([]byte, []int) {
	return file_api_v1_database_raft_cluster_proto_rawDescGZIP(), []int{9}
}
...
var file_api_v1_database_raft_cluster_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x08, 0x64, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x22, 0xd1,
	0x05, 0x0a, 0x12, 0x52, 0x61, 0x66, 0x74, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x50, 0x61,
	0x79, 0x6c, 0x6f, 0x61, 0x64, 0x12, 0x69, 0x0a, 0x1b, 0x47, 0x65, 0x74, 0x43, 0x6c, 0x75, 0x73,
	0x74, 0x65, 0x72, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x73, 0x68, 0x69, 0x70, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x25, 0x2e, 0x64, 0x61, 0x74,
	...
	0x74, 0x48, 0x00, 0x52, 0x1b, 0x47, 0x65, 0x74, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x4d,
	0x65, 0x6d, 0x62, 0x65, 0x72, 0x73, 0x68, 0x69, 0x70, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x12, 0x6c, 0x0a, 0x1c, 0x47, 0x65, 0x74, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x4d, 0x65,
	...
	,
	...
	,
	...
	0x3a, 0x02, 0x38, 0x01, 0x1a, 0x4c, 0x0a, 0x0c, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x64, 0x45,
	0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x04, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x26, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65,
	0x2e, 0x4e, 0x69, 0x6c, 0x56, 0x61, 0x6c, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02,
	0x38, 0x01, 0x22, 0x08, 0x0a, 0x06, 0x4e, 0x69, 0x6c, 0x56, 0x61, 0x6c, 0x22, 0x32, 0x0a, 0x12,
	...
	,
	...
	,
	...
	,
...
var file_api_v1_database_raft_cluster_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_api_v1_database_raft_cluster_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_api_v1_database_raft_cluster_proto_goTypes = []interface{}{
	(RaftClusterPayload_MethodName)(0),   // 0: database.RaftClusterPayload.MethodName
	(*RaftClusterPayload)(nil),           // 1: database.RaftClusterPayload
	(*GetClusterMembershipRequest)(nil),  // 2: database.GetClusterMembershipRequest
	(*GetClusterMembershipResponse)(nil), // 3: database.GetClusterMembershipResponse
	(*RaftMembership)(nil),               // 4: database.RaftMembership
	(*NilVal)(nil),                       // 5: database.NilVal
	(*StopClusterRequest)(nil),           // 6: database.StopClusterRequest
	(*StopClusterResponse)(nil),          // 7: database.StopClusterResponse
	(*StartClusterRequest)(nil),          // 8: database.StartClusterRequest
	(*StartClusterResponse)(nil),         // 9: database.StartClusterResponse
	(*RaftConfig)(nil),                   // 10: database.RaftConfig
	nil,                                  // 11: database.RaftMembership.NodesEntry
	nil,                                  // 12: database.RaftMembership.ObserversEntry
	nil,                                  // 13: database.RaftMembership.WitnessesEntry
	nil,                                  // 14: database.RaftMembership.RemovedEntry
	nil,                                  // 15: database.StartClusterRequest.InitialMembersEntry
}
var file_api_v1_database_raft_cluster_proto_depIdxs = []int32{
	2,  // 0: database.RaftClusterPayload.GetClusterMembershipRequest:type_name -> database.GetClusterMembershipRequest
	3,  // 1: database.RaftClusterPayload.GetClusterMembershipResponse:type_name -> database.GetClusterMembershipResponse
	6,  // 2: database.RaftClusterPayload.StopClusterRequest:type_name -> database.StopClusterRequest
	...
	13, // 10: database.RaftMembership.Witnesses:type_name -> database.RaftMembership.WitnessesEntry
	14, // 11: database.RaftMembership.Removed:type_name -> database.RaftMembership.RemovedEntry
	15, // 12: database.StartClusterRequest.initialMembers:type_name -> database.StartClusterRequest.InitialMembersEntry
...
func file_api_v1_database_raft_cluster_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_v1_database_raft_cluster_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RaftClusterPayload); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_v1_database_raft_cluster_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
	...
	file_api_v1_database_raft_cluster_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*RaftClusterPayload_GetClusterMembershipRequest)(nil),
		(*RaftClusterPayload_GetClusterMembershipResponse)(nil),
		(*RaftClusterPayload_StopClusterRequest)(nil),
		(*RaftClusterPayload_StopClusterResponse)(nil),
		(*RaftClusterPayload_StartClusterRequest)(nil),
		(*RaftClusterPayload_StartClusterResponse)(nil),
	}
	file_api_v1_database_raft_cluster_proto_msgTypes[7].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_api_v1_database_raft_cluster_proto_enumTypes,
