...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 18: {
            ...
            kv_ = input.readMessage(io.a13s.api.kvstore.v1.KeyValue.parser(), extensionRegistry);
            if (subBuilder != null) {
          ...
          case 26: {
            ...
            prevKv_ = input.readMessage(io.a13s.api.kvstore.v1.KeyValue.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      io.a13s.api.kvstore.v1.Event parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (io.a13s.api.kvstore.v1.Event) e.getUnfinishedMessage();
