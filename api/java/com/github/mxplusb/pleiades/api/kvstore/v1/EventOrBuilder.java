...
public interface EventOrBuilder extends
   ...
   * @return The type.
   */
  com.github.mxplusb.pleiades.api.kvstore.v1.KeyOperationType getType();
   ...
   * @return The kv.
   */
  com.github.mxplusb.pleiades.api.kvstore.v1.KeyValue getKv();
  /**
   * <pre>
   * kv holds the KeyValue for the event.
   * A PUT event contains current kv pair.
   ...
   * <code>.kvstore.v1.KeyValue kv = 2 [json_name = "kv"];</code>
   */
  com.github.mxplusb.pleiades.api.kvstore.v1.KeyValueOrBuilder getKvOrBuilder();
   ...
   * @return The prevKv.
   */
  com.github.mxplusb.pleiades.api.kvstore.v1.KeyValue getPrevKv();
  /**
   * <pre>
   * prev_kv holds the key-value pair before the event happens.
   * </pre>
   ...
   * <code>optional .kvstore.v1.KeyValue prev_kv = 3 [json_name = "prevKv"];</code>
   */
  com.github.mxplusb.pleiades.api.kvstore.v1.KeyValueOrBuilder getPrevKvOrBuilder();
}
