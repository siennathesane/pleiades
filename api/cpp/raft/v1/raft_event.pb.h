...
inline ::raft::v1::EventType RaftEvent::_internal_typ() const {
  return static_cast< ::raft::v1::EventType >(typ_);
}
...
inline ::raft::v1::Event RaftEvent::_internal_action() const {
  return static_cast< ::raft::v1::Event >(action_);
}
...
inline ::raft::v1::RaftLogEntryEvent* RaftEvent::release_log_entry() {
  ...
  if (_internal_has_log_entry()) {
    clear_has_event();
    ::raft::v1::RaftLogEntryEvent* temp = event_.log_entry_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    event_.log_entry_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::raft::v1::RaftLogEntryEvent* RaftEvent::_internal_mutable_log_entry() {
  if (!_internal_has_log_entry()) {
    clear_event();
    set_has_log_entry();
    event_.log_entry_ = CreateMaybeMessage< ::raft::v1::RaftLogEntryEvent >(GetArenaForAllocation());
  }
  return event_.log_entry_;
}
...
inline ::raft::v1::RaftSnapshotEvent* RaftEvent::release_snapshot() {
  ...
  if (_internal_has_snapshot()) {
    clear_has_event();
    ::raft::v1::RaftSnapshotEvent* temp = event_.snapshot_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    event_.snapshot_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::raft::v1::RaftSnapshotEvent* RaftEvent::_internal_mutable_snapshot() {
  if (!_internal_has_snapshot()) {
    clear_event();
    set_has_snapshot();
    event_.snapshot_ = CreateMaybeMessage< ::raft::v1::RaftSnapshotEvent >(GetArenaForAllocation());
  }
  return event_.snapshot_;
}
...
inline ::raft::v1::RaftConnectionEvent* RaftEvent::release_connection() {
  ...
  if (_internal_has_connection()) {
    clear_has_event();
    ::raft::v1::RaftConnectionEvent* temp = event_.connection_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    event_.connection_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::raft::v1::RaftConnectionEvent* RaftEvent::_internal_mutable_connection() {
  if (!_internal_has_connection()) {
    clear_event();
    set_has_connection();
    event_.connection_ = CreateMaybeMessage< ::raft::v1::RaftConnectionEvent >(GetArenaForAllocation());
  }
  return event_.connection_;
}
...
inline ::raft::v1::RaftNodeEvent* RaftEvent::release_node() {
  ...
  if (_internal_has_node()) {
    clear_has_event();
    ::raft::v1::RaftNodeEvent* temp = event_.node_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    event_.node_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::raft::v1::RaftNodeEvent* RaftEvent::_internal_mutable_node() {
  if (!_internal_has_node()) {
    clear_event();
    set_has_node();
    event_.node_ = CreateMaybeMessage< ::raft::v1::RaftNodeEvent >(GetArenaForAllocation());
  }
  return event_.node_;
}
...
inline ::raft::v1::RaftHostShutdown* RaftEvent::release_host_shutdown() {
  ...
  if (_internal_has_host_shutdown()) {
    clear_has_event();
    ::raft::v1::RaftHostShutdown* temp = event_.host_shutdown_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    event_.host_shutdown_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::raft::v1::RaftHostShutdown* RaftEvent::_internal_mutable_host_shutdown() {
  if (!_internal_has_host_shutdown()) {
    clear_event();
    set_has_host_shutdown();
    event_.host_shutdown_ = CreateMaybeMessage< ::raft::v1::RaftHostShutdown >(GetArenaForAllocation());
  }
  return event_.host_shutdown_;
}
...
inline RaftEvent::EventCase RaftEvent::event_case() const {
  return RaftEvent::EventCase(_oneof_case_[0]);
}
// -------------------------------------------------------------------
