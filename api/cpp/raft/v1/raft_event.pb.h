...
#ifndef GOOGLE_PROTOBUF_INCLUDED_raft_2fv1_2fraft_5fevent_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_raft_2fv1_2fraft_5fevent_2eproto_2epb_2eh
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable
    descriptor_table_raft_2fv1_2fraft_5fevent_2eproto;
namespace raft {
namespace v1 {
...
PROTOBUF_NAMESPACE_OPEN
template <>
::raft::v1::RaftConnectionEvent* Arena::CreateMaybeMessage<::raft::v1::RaftConnectionEvent>(Arena*);
template <>
::raft::v1::RaftEvent* Arena::CreateMaybeMessage<::raft::v1::RaftEvent>(Arena*);
template <>
::raft::v1::RaftHostShutdown* Arena::CreateMaybeMessage<::raft::v1::RaftHostShutdown>(Arena*);
template <>
::raft::v1::RaftLeaderInfo* Arena::CreateMaybeMessage<::raft::v1::RaftLeaderInfo>(Arena*);
template <>
::raft::v1::RaftLogEntryEvent* Arena::CreateMaybeMessage<::raft::v1::RaftLogEntryEvent>(Arena*);
template <>
::raft::v1::RaftNodeEvent* Arena::CreateMaybeMessage<::raft::v1::RaftNodeEvent>(Arena*);
template <>
::raft::v1::RaftSnapshotEvent* Arena::CreateMaybeMessage<::raft::v1::RaftSnapshotEvent>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
constexpr Event Event_MAX = static_cast<Event>(16);
constexpr int Event_ARRAYSIZE = 16 + 1;
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor*
Event_descriptor();
template <typename T>
...
inline const std::string& Event_Name(Event value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfDenseEnum<Event_descriptor,
                                                 0, 16>(
      static_cast<int>(value));
}
...
inline PROTOBUF_ALWAYS_INLINE void RaftConnectionEvent::set_address(Arg_&& arg,
                                                     Args_... args) {
  ;
...
inline void RaftConnectionEvent::set_allocated_address(std::string* value) {
...
template <>
struct is_proto_enum<::raft::v1::EventType> : std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor<::raft::v1::EventType>() {
  return ::raft::v1::EventType_descriptor();
}
template <>
struct is_proto_enum<::raft::v1::Event> : std::true_type {};
template <>
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_raft_2fv1_2fraft_5fevent_2eproto_2epb_2eh
