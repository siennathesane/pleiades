...
inline bool CreateAccountResponse::_internal_has_account_descriptor() const {
  return this != internal_default_instance() && _impl_.account_descriptor_ != nullptr;
}
...
inline bool AccountDescriptor::_internal_has_created() const {
  return this != internal_default_instance() && _impl_.created_ != nullptr;
}
...
inline bool CreateBucketResponse::_internal_has_bucket_descriptor() const {
  return this != internal_default_instance() && _impl_.bucket_descriptor_ != nullptr;
}
...
inline bool GetKeyResponse::_internal_has_key_value_pair() const {
  return this != internal_default_instance() && _impl_.key_value_pair_ != nullptr;
}
...
void KeyValueDescriptor::set_current_key(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.current_key_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void KeyValueDescriptor::set_allocated_current_key(std::string* current_key) {
  ...
  _impl_.current_key_.SetAllocated(current_key, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
