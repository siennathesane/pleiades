...
func (f *FlagSet) BoolVar(i *BoolVar) {
	...
	flagVal := newBoolValue(i.ConfigurationPath, def, i.Target, i.Hidden)
...
func newBoolValue(name string, def bool, target *bool, hidden bool) *boolValue {
	*target = def
...
func (b *boolValue) HasChanged() bool {
	return true
}
...
func (b *boolValue) ValueString() string {
	return b.String()
}

func (b *boolValue) ValueType() string {
	return "bool"
}
...
func (f *FlagSet) Int64Var(i *Int64Var) {
	...
	config.SetDefault(i.ConfigurationPath, initial)
...
func (f *FlagSet) UintVar(i *UintVar) {
	...
	config.SetDefault(i.ConfigurationPath, i.Default)
...
func (f *FlagSet) Uint32Var(i *Uint32Var) {
	initial := i.Default
	if v, exist := os.LookupEnv(i.EnvVar); exist {
	...
	flagVal := newUint32Value(i.ConfigurationPath, initial, i.Target, i.Hidden)
...
func newUint32Value(name string, def uint32, target *uint32, hidden bool) *uint32Value {
	*target = def
	return &uint32Value{
		name:   name,
		hidden: hidden,
...
func (i *uint32Value) HasChanged() bool {
	return true
}

func (i *uint32Value) Name() string {
	return i.name
}

func (i *uint32Value) ValueString() string {
	return i.String()
}

func (i *uint32Value) ValueType() string {
	return "uint32"
}
...
func (i *uint32Value) Get() interface{} { return uint64(*i.target) }
func (i *uint32Value) String() string   { return strconv.FormatUint(uint64(*i.target), 10) }
func (i *uint32Value) Example() string  { return "uint" }
func (i *uint32Value) Hidden() bool     { return i.hidden }
...
func newUint64Value(name string, def uint64, target *uint64, hidden bool) *uint64Value {
	*target = def
	return &uint64Value{
		name:   name,
		hidden: hidden,
...
func (i *uint64Value) HasChanged() bool {
	return true
}

func (i *uint64Value) Name() string {
	return i.name
}

func (i *uint64Value) ValueString() string {
	return i.String()
}

func (i *uint64Value) ValueType() string {
	return "uint64"
}
...
func (f *FlagSet) StringVar(i *StringVar) {
	...
	flagVal := newStringValue(i.ConfigurationPath, initial, i.Target, i.Hidden)
...
func (s *stringValue) HasChanged() bool {
	return true
}

func (s *stringValue) Name() string {
	return s.name
}
...
func (s *stringValue) ValueType() string {
	return "string"
}

func newStringValue(name, def string, target *string, hidden bool) *stringValue {
	*target = def
	return &stringValue{
		name:   name,
		hidden: hidden,
...
func (f *FlagSet) DurationVar(i *DurationVar) {
	...
	f.VarFlag(&VarFlag{
		...
		Completion:        i.Completion,
		ConfigurationPath: i.ConfigurationPath,
	})
}
...
func (v *VarFlag) HasChanged() bool {
	return false
}

func (v *VarFlag) Name() string {
	return v.FlagName
}

func (v *VarFlag) ValueString() string {
	return v.Value.String()
}

func (v *VarFlag) ValueType() string {
	return v.internalType
}
...
func (f *FlagSet) VarFlag(i *VarFlag) {
	...
	f.Var(i.Value, i.FlagName, usage)
	f.completions["-"+i.FlagName] = i.Completion
}
